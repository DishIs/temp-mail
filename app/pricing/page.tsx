        ...
        <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-1">
                ...
                <AccordionContent className="text-muted-foreground">
                    <p className="mb-2"><strong>Free/None:</strong> You are stuck with our public domains (e.g., @saleis.live). These are great for signups but can sometimes be flagged by strict websites.</p>
