...
export default function ProfilePage() {
    ...
    const paymentProviderName = userData?.subscription?.provider === 'paypal' ? 'PayPal' : 'Paddle';
                        ...
                        <TabsContent value="billing" className="space-y-6">
                                    ...
                                    {isPro && userData?.subscription && (
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-xs text-muted-foreground flex items-center gap-1">
                                                {t('billing.payment_via')}{' '}
                                                {userData.subscription.provider === 'paypal'
                                                    ? <span className="font-bold text-blue-600">PayPal</span>
                                                    : <span className="font-bold text-emerald-600">Paddle</span>}
                                            </p>
                                        </div>
                                    )}
                                </CardContent>
                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        {t('billing.trans_desc', { provider: userData?.subscription?.provider === 'paypal' ? 'PayPal' : 'Paddle' })}
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                                        ...
                                        {isPro ? (
                                            <>
                                                ...
                                                <Button variant="outline" size="sm" onClick={handleManageSubscription} className="mt-2">
                                                    {userData?.subscription?.provider === 'paddle'
                                                        ? 'Manage on Paddle →'
