...
export default function CreditsPage() {
  return (
    <article className="prose prose-neutral dark:prose-invert max-w-none">
      ...
      <p className="text-sm text-muted-foreground">$10 → 200k · $25 → 600k · $50 → 1.5M · $100 → 4M requests. Credits never expire; they are consumed automatically after your monthly quota is exhausted.</p>
