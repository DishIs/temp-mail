...
const API_PAGES = [
  ...
  { title: "Use Cases", url: "/api/use-cases", description: "Common disposable email patterns and guides.", type: "api" },
  { title: "Playwright & Selenium", url: "/api/use-cases/playwright-selenium", description: "Automate E2E testing signup flows.", type: "api" },
  { title: "OTP Extraction Use Case", url: "/api/use-cases/otp-extraction", description: "Extract verification codes without regex.", type: "api" },
