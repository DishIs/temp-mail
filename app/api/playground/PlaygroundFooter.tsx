// components/PlaygroundFooter.tsx
"use client";
...
export function PlaygroundFooter() {
  return (
    <footer className="border-t border-border bg-background text-foreground w-full shrink-0">
      ...
      <div className="border-b border-border">
        <div className="max-w-[90rem] mx-auto grid grid-cols-2 sm:grid-cols-4 divide-x divide-border">
          ...
          <div className="px-8 py-8 flex items-start gap-2">
          ...
          <div className="px-8 py-8 col-span-2 border-l border-border space-y-3">
      ...
      <div className="max-w-[90rem] mx-auto px-8 py-5">
        <a href="https://www.buymeacoffee.com/dishantsinghdev" target="_blank" rel="noopener noreferrer">
          <img src="https://cdn.buymeacoffee.com/buttons/v2/default-yellow.png" alt="Buy Me A Coffee" className="h-7 w-auto" />
        </a>
      </div>
