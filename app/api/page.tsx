...
const PLANS = [
  ...
  { name: "Developer",  price: "$7/mo",   reqSec: "10",  reqMonth: "100,000",    otp: true,  ws: false, att: false, cd: false, support: "Email" },
  { name: "Startup",    price: "$19/mo",  reqSec: "25",  reqMonth: "500,000",    otp: true,  ws: true,  att: true,  cd: false, support: "Email" },
...
const HOW_IT_WORKS = [
  ...
  { step: "03", title: "Read or stream",       desc: "Fetch messages with GET or subscribe via WebSocket." },
];
    ...
    <div className="bg-background text-foreground overflow-x-hidden">
      ...
      <section className="relative border-t border-border px-6 py-20" style={DOT_BG}>
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          <FadeIn>
            <SectionMarker index={2} total={T} label="About this API" />
      ...
      <section className="relative border-t border-border px-6 py-24" style={DOT_BG}>
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          <FadeIn>
            <SectionMarker index={3} total={T} label="Features" />
      ...
      <section className="relative border-t border-border px-6 py-24">
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          <FadeIn>
            <SectionMarker index={4} total={T} label="How it works" />
      ...
      <section className="relative border-t border-border px-6 py-24" style={DOT_BG}>
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          <FadeIn>
            <SectionMarker index={5} total={T} label="Plan comparison" />
      ...
      <section className="relative border-t border-border px-6 py-24">
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          <FadeIn>
            <SectionMarker index={6} total={T} label="Quickstart" />
      ...
      <section className="relative border-t border-border px-6 py-24" style={DOT_BG}>
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          <FadeIn>
            <SectionMarker index={7} total={T} label="Credits — never expire" />
