...
import {
  Clock, Check, ArrowRight, ChevronRight, Bell, Workflow, Bot, LayoutGrid
} from "lucide-react";
    ...
    <div className="bg-background text-foreground overflow-x-hidden min-h-screen">
      ...
      <section className="relative px-6 py-28 md:py-36 text-center" style={DOT_BG}>
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <motion.div className="text-6xl mb-6" initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.05 }}>
            ⚡
          </motion.div>
          ...
          >
            FreeCustom.Email<br />for Zapier
          </motion.h1>
          ...
          >
            Native Zapier integration — trigger Zaps the moment an email arrives, extract OTPs automatically, and connect your disposable inboxes to 5,000+ apps.
          </motion.p>
          ...
          >
            {submitted ? (
              <div className="flex items-center justify-center gap-2 p-4 rounded-lg bg-emerald-500/5 border border-emerald-500/20">
                ...
                <span className="text-sm font-mono text-emerald-600">You&apos;re on the list! We&apos;ll notify you.</span>
              </div>
            ) : (
              <form onSubmit={handleNotify} className="flex gap-2">
                <input
                  ...
                  required
                  className="flex-1 h-9 px-3 text-sm rounded-md border border-border bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-foreground/30"
                />
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          <FadeIn>
            <div className="flex items-center gap-2 mb-10">
              ...
              <span className="font-mono text-xs uppercase tracking-widest text-muted-foreground">Example Zaps</span>
            </div>
            <h2 className="text-3xl font-bold mb-14 tracking-tight">What you&apos;ll be able to build</h2>
          </FadeIn>
                ...
                <div className="bg-background px-6 py-7 h-full hover:bg-muted/10 transition-colors relative">
                  ...
                  <div className="space-y-1 mb-3">
                    <div className="flex items-center gap-2">
                      <span className="font-mono text-[9px] uppercase tracking-wider text-muted-foreground/50">When</span>
                      <span className="text-xs text-foreground font-medium">{zap.trigger}</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <span className="font-mono text-[9px] uppercase tracking-wider text-muted-foreground/50">Then</span>
                      <span className="text-xs text-foreground font-medium">{zap.action}</span>
                    </div>
                  </div>
                  <p className="text-xs text-muted-foreground leading-relaxed">{zap.desc}</p>
                </div>
              </FadeIn>
            ))}
          </div>
      ...
      <section className="relative border-t border-border px-6 py-24" style={DOT_BG}>
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          <FadeIn>
            <div className="flex items-center gap-2 mb-10">
              <div className="w-0.5 h-4 bg-border" />
              <span className="font-mono text-xs uppercase tracking-widest text-muted-foreground">Actions & Triggers</span>
            </div>
            <div className="grid lg:grid-cols-2 gap-14">
              <div>
                <h2 className="text-3xl font-bold mb-4 tracking-tight">FCE actions for Zapier</h2>
                <p className="text-sm text-muted-foreground mb-8 leading-relaxed">
                  Planned actions you&apos;ll be able to use in any Zap once the integration launches.
                </p>
              ...
              <div>
                <h2 className="text-3xl font-bold mb-4 tracking-tight">In the meantime</h2>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    >
                      <span className="text-muted-foreground group-hover:text-foreground transition-colors">{alt.icon}</span>
