...
import {
  Clock, Check, ArrowRight, ChevronRight, Bell, Workflow, Zap, Bot
} from "lucide-react";
    ...
    <div className="bg-background text-foreground overflow-x-hidden min-h-screen">
      ...
      <section className="relative px-6 py-28 md:py-36 text-center" style={DOT_BG}>
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          >
            Native Make (formerly Integromat) integration — disposable inboxes, OTP extraction, and real-time email triggers, all as drag-and-drop modules in your scenarios.
          </motion.p>
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          <FadeIn>
            <div className="flex items-center gap-2 mb-10">
              ...
              <span className="font-mono text-xs uppercase tracking-widest text-muted-foreground">Planned modules</span>
            </div>
            <h2 className="text-3xl font-bold mb-14 tracking-tight">What&apos;s coming</h2>
          </FadeIn>
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          <FadeIn>
            ...
            <div className="grid lg:grid-cols-2 gap-14">
              <div>
                <h2 className="text-3xl font-bold mb-6 tracking-tight">Connect email to everything</h2>
                <p className="text-sm text-muted-foreground mb-8 leading-relaxed">
                  With 2,000+ Make integrations, you&apos;ll be able to pipe disposable inbox data into any app — without writing a single line of code.
                </p>
                <ul className="space-y-2.5">
                  {USE_CASES.map(uc => (
                    <li key={uc} className="flex items-center gap-3 text-sm font-mono text-muted-foreground">
                      <Check className="h-3.5 w-3.5 text-muted-foreground/40 shrink-0" /> {uc}
                    </li>
                  ))}
                </ul>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2 mb-6">
                  <div className="w-0.5 h-4 bg-border" />
                  <span className="font-mono text-xs uppercase tracking-widest text-muted-foreground">In the meantime</span>
                </div>
                {[
                  {
